...
`<userStyle>`THIS IS A PLACEHOLDER userStyle WHICH SHOULD BE INCLUDED IN FULL PRINT`</userStyle>`  the prompt content here. You can include instructions, examples, and any other relevant information to guide the AI's responses.