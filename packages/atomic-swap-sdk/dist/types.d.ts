...
export type ChainId = "ethereum" | "ethereum-sepolia" | "polygon" | "bsc" | "arbitrum" | "optimism" | "base" | "avalanche" | "solana" | "solana-devnet" | "bitcoin" | "bitcoin-testnet" | "x3-substrate" | string;
export type AmmProtocol = "uniswap-v2" | "uniswap-v3" | "raydium" | "orca-whirlpool" | "x3-amm" | "constant-product" | "stable-swap";
export type HTLCStatus = "pending" | "funded" | "claimed" | "refunded" | "expired";
...
export type SwapStatus = "initiated" | "htlc-created-source" | "htlc-created-destination" | "claimed" | "refunded" | "expired" | "failed";
...
export type DexEventType = "order-created" | "order-filled" | "order-partial-fill" | "order-cancelled" | "trade-executed" | "swap-initiated" | "swap-htlc-funded" | "swap-claimed" | "swap-refunded" | "swap-expired" | "orderbook-update" | "price-update" | "error";
