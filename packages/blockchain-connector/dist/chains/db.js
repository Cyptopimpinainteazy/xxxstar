...
export class ChainDB {
    ...
    getChainsByFamilyNetwork(family, network) {
    ...
    searchChains(query) {
        ...
        if (byName)
            return byName.slice(0, 10); // Limit results
        return [];
    }
    getNextRpc(chainId) {
