...
export type ComitFailureReason = {
    ...
    type: 'EvmExecutionFailed';
    gasUsed: bigint;
    error: string;
} | {
    type: 'SvmExecutionFailed';
    computeUnits: bigint;
    error: string;
} | {
...
export type ComitEvent = {
    type: 'submitted';
    data: ComitSubmittedEvent;
} | {
    type: 'executionStarted';
    data: ComitExecutionStartedEvent;
} | {
    type: 'executionCompleted';
    data: ComitExecutionCompletedEvent;
} | {
    type: 'finalized';
    data: ComitFinalizedEvent;
} | {
    type: 'failed';
    data: ComitFailedEvent;
};
