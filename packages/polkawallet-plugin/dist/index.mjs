...
function getSdkConfig() {
  const networkEnv = getEnv("X3_NETWORK", "local").toLowerCase();
...
var X3ChainApi = class extends import_index.default {
  ...
  async connect() {
    ...
    this._isDisconnecting = false;
    this._reconnectAttempts = 0;
    this._provider = new WsProvider(endpoint, this._config.autoReconnect ? 1e3 : false);
