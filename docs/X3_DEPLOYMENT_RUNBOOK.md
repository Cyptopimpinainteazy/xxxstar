...
8. CI/release gates required by the launch scope have passed for the exact release being deployed. A workflow file or prior report is not proof of a passing run.
