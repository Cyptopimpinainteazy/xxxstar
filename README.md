...
- [RELEASE_GATES.md](./RELEASE_GATES.md) — mainnet release gates summary (binary pass/fail gate tracker, retired MAINNET_LAUNCH_CHECKLIST.md archived under Desktop/xxxstar/olddocs)
