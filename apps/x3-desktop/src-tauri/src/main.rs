...
fn main() {
  ...
  Builder::default()
    ...
    .invoke_handler(generate_handler![
      ...
      wallet::list_signing_requests,
      wallet::list_signed_transactions,
      wallet::approve_signing_request,
      wallet::reject_signing_request,
      wallet::probe_hardware_wallet_bridge,
      wallet::list_hardware_wallet_devices,
      wallet::list_multisig_wallets,
      wallet::list_multisig_approvals,
      wallet::list_multisig_cosigners,
      wallet::create_multisig_wallet,
      wallet::approve_multisig_proposal,
      wallet::reject_multisig_proposal,
      wallet::add_multisig_cosigner,
      wallet::list_privacy_addresses,
      wallet::create_stealth_address,
      wallet::list_privacy_transactions,
      wallet::start_privacy_mix,
      wallet::get_privacy_audit_report,
