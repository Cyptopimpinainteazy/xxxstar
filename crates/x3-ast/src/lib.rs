...
/// An arbitrage program definition.
...
/// A single step in an arbitrage path.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Step {
    pub from: Asset,
    pub to: Asset,
...
/// Validation conditions for arbitrage logic.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub enum Guard {
    Slippage(u64),
    Profit(Amount),
...
/// Error recovery logic for failed arbitrage steps.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub enum FailHandler {
    RollbackRefund,
    Retry(u32),
    WaitAndNotify,
}

/// A cross-chain asset identifier.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Asset {
    pub chain: Chain,
    pub token: String,
...
/// Supported chains for cross-VM swaps.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub enum Chain {
    Solana,
    Ethereum,
