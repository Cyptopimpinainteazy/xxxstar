...
pub trait WeightInfo {
    ...
    fn verify_aggregate_signature(s: u32) -> Weight;
    fn verify_agents(s: u32) -> Weight;
    fn verify_multikey_proof(s: u32) -> Weight;
    fn x3_crypto_sort(s: u32) -> Weight;
}
...
impl WeightInfo for () {
    ...
    fn verify_aggregate_signature(s: u32) -> Weight {
        Weight::from_parts(100_000_000, 0).saturating_mul(s as u64)
    }

    fn verify_agents(s: u32) -> Weight {
        Weight::from_parts(150_000_000, 0).saturating_mul(s as u64)
    }

    fn verify_multikey_proof(s: u32) -> Weight {
        Weight::from_parts(200_000_000, 0).saturating_mul(s as u64)
    }

    fn x3_crypto_sort(s: u32) -> Weight {
        Weight::from_parts(50_000_000, 0).saturating_mul(s as u64)
    }
}
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn verify_aggregate_signature(s: u32) -> Weight {
        Weight::from_parts(100_000_000, 0)
            .saturating_add(T::DbWeight::get().reads(2).saturating_mul(s as u64))
            .saturating_add(T::DbWeight::get().writes(0))
    }

    fn verify_agents(s: u32) -> Weight {
        Weight::from_parts(150_000_000, 0)
            .saturating_add(T::DbWeight::get().reads(3).saturating_mul(s as u64))
            .saturating_add(T::DbWeight::get().writes(1))
    }
