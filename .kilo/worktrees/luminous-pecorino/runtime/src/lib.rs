...
use pallet_x3_keyring;
use pallet_x3_identity_verifier;
use pallet_x3_solvency;
use pallet_x3_wallet_pallet;
use pallet_x3_inventory;
use pallet_x3_reservation;
...
use x3_primitives::keyring::KeyringVerifier;
...
parameter_types! {
    ...
    pub const MaxVerifierNonce: u64 = u64::MAX;
}
...
impl pallet_x3_verifier::Config for Runtime {
    ...
    type MaxNonce = MaxVerifierNonce;
...
// ===== X3 Identity Verifier Configuration =====
parameter_types! {
    pub const MinVerifierStake: u128 = 1_000 * X3;
    pub const MaxProofSize: u32 = 512;
    pub const MaxIdentityDataSize: u32 = 256;
    pub const MaxIdentitiesPerVerifier: u32 = 100;
    pub const MinConfirmations: u32 = 3;
    pub const MaxConfirmations: u32 = 100;
    pub const ProofTimeout: u32 = 1_000; // ~20 minutes at 200ms blocks
    pub const VerificationReward: u128 = 10 * X3;
    pub const VerificationSlashAmount: u128 = 100 * X3;
    pub const IdentityExpiryBlocks: u32 = 1_000_000; // ~2.3 days at 200ms blocks
}

impl pallet_x3_identity_verifier::Config for Runtime {
    type RuntimeEvent = RuntimeEvent;
    type Currency = Balances;
    type VerifierRegistrar = EnsureRootOrHalfCouncil;
    ...
    type WeightInfo = pallet_x3_identity_verifier::weights::SubstrateWeight<Runtime>;
}

// ===== X3 Keyring Configuration =====
#[cfg(feature = "x3-keyring")]
parameter_types! {
    pub const KeyringPalletId: frame_support::PalletId = frame_support::PalletId(*b"x3/keyr");
    pub const MinAttestorStake: u128 = 1_000 * X3;
    pub const MaxProofSize: u32 = 512;
    ...
    pub const ProofTimeout: u32 = 1_000; // ~20 minutes at 200ms blocks
    pub const VerificationReward: u128 = 10 * X3;
    pub const AttestationSlashAmount: u128 = 100 * X3;
}

#[cfg(feature = "x3-keyring")]
impl pallet_x3_keyring::Config for Runtime {
    type RuntimeEvent = RuntimeEvent;
    type Currency = Balances;
    type AttestorRegistrar = EnsureRootOrHalfCouncil;
    ...
    type WeightInfo = pallet_x3_keyring::weights::SubstrateWeight<Runtime>;
}
