...
fn main() {
    ...
    // X3 RC1 build stabilization: rustc 1.90.0 ICEs in rustix' diagnostic
    // lifetime lint path when this cfg is enabled. Keep diagnostics off for
    // reproducible node builds until the toolchain is upgraded past the ICE.
